...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <table class="table datatable-autofill-basic" id="tb_admin">
            <thead>
                <tr>
                    <th style="text-align: center">Thêm sản phẩm</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                        ...
                        <form action="" method="post" accept-charset="utf-8">
                            ...
                            <div class="row">
                                <table id="tb_them">
                                    <tr>
                                        <td>
                                            <label class="red">*</label><span>Tên sản phẩm: </span>
                                            <input type="text" class="form-control" id="usr" name="tensp" required>
                                        </td>
                                        <td>
                                            <label class="red">*</label><span>Chọn loại sản phẩm: </span>
                                            <br>
                                            <select name="id_loai" style="border-radius: 3px;padding:6px;border:1px solid #DDD;width: 470px">
                                                @foreach($loaisp as $loai)
                                                <option value="{{ $loai->id }}">{{ $loai->tenloai }}</option>} @endforeach
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label class="red">*</label><span>Đơn giá: </span>
                                            <input type="text" class="form-control" id="" name="dongia" required>
                                        </td>
                                        <td>
                                            <label class="red">*</label><span>Chọn nhà cung cấp: </span>
                                            <br>
                                            <select name="ncc" style="border-radius: 3px;padding:6px;border:1px solid #DDD;width: 470px">
                                                @foreach($nhacungcap as $ncc)
                                                <option value="{{ $ncc->id }}">{{ $ncc->ten_ncc }}</option>} @endforeach
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td rowspan="3">
                                            <label class="red">*</label><span>Ảnh sản phẩm:</span>
                                            <input type='file' accept='image/*' onchange='openFile(event)' class="hidden" id="ImgProd" name="img">
                                            <br>
                                            <img id="output" class="thumbnail" width="150px" src="upload/sanpham/90402798-hand-click-icon-bold-line.jpg" name="" required style="width: 200px;height: 150px;">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label class="red">*</label><span>Đơn vị tính: </span>
                                            <input type="text" class="form-control" id="" name="don_vi_tinh" required>
                                        </td>
