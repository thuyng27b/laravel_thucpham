    ...
    <div class="page-header-content">
        ...
        <div class="heading-elements">
            <div class="heading-btn-group">
                <a href="{{ route('ds-hd-nhap')  }}" class="btn btn-info"><i class="fas fa-backward"></i>&nbsp;Quay lại</a>
               <a href="{{-- {{ route('them-san-pham') }} --}}" class="btn btn-primary"><i class="fas fa-plus"></i>&nbsp;&nbsp;Thêm mới</button></a>
                <!-- Modal -->
            </div>
        </div>
                ...
                @foreach($ct_hd as $hd)
                 @php $stt++;@endphp
                    <tr>
                        ...
                        <td>{{ $hd->sl }}</td>
                        <td style="color:red">{{ number_format($sp_nhap->tong_tien/$hd->sl,0,',','.')}}</td>
                        <td>
